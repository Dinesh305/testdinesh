...
try:
  ...
  for evnt_db in envt_dbuser_list:
    ...
    for k,v in RedshiftFinalTable.items():
      ...
      run_track_result = "Load to run-tracking "+ rs_dbname + " in " + rs_env +": FAILED"
      ...
      try:
        ...
        print ("Run tracking for :" + v + " table in db "+ rs_dbname + " " + rs_env)
        print ("===========================================================================================")
        ...
        run_track_result = "Load " + v +" to run-tracking " + rs_dbname + " " + rs_env + ": SUCCESS \n"
        passed.append(run_track_result)
      ###########################################################################################################
      except Exception as e:
        print(str(e))
        run_track_result = "Load " + v +" to run-tracking " + rs_dbname + " " + rs_env + ": FAILED \n"
